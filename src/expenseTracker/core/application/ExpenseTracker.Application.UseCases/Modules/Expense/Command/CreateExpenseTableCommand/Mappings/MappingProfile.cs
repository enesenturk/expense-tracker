...
namespace ExpenseTracker.Application.UseCases.Modules.Expense.Command.CreateExpenseTableCommand.Mappings
{
	public class MappingProfile : Profile
	{
		...
		public MappingProfile()
		{
			...
			CreateMap<Create_ExpenseTable_SingleCommandDto, t_expense>()
