...
namespace ExpenseTracker.Application.UseCases.Modules.Expense.Query.GetListExpenseTableQuery.Mappings
{
	public class MappingProfile : Profile
	{
		...
		public MappingProfile()
		{
			...
			CreateMap<t_expense, GetList_ExpenseTable_SingleResponseDto>()
