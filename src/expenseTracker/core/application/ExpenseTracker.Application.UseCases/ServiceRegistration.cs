...
namespace ExpenseTracker.Application.UseCases
{
	public static class ServiceRegistration
	{
		public static IServiceCollection AddUseCaseCommonServices(this IServiceCollection services)
		{
			...
			services.AddScoped<Create_CategoryTable_Command_BusinessRules>();
			...
			services.AddScoped<Create_SubCategoryTable_Command_BusinessRules>();
			services.AddScoped<Update_SubCategory_Command_BusinessRules>();
			services.AddScoped<Delete_SubCategory_Command_BusinessRules>();

			services.AddScoped<Create_ExpenseTable_Command_BusinessRules>();
